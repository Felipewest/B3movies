...
PICS = (environ.get('PICS', 'https://telegra.ph/Photo-07-30-25')).split()
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/B3Moviesrequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/B3botofficial')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/B3botofficial/24')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', '➕ just add me your group see my power🤘')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/b3botsupport')
